<div class="section-one pt-1">
    <div class="container mt-5">
        <div class="row justify-content-between align-items-center">
            <div class="col-sm-7">
                <div class="row">
                    <h1 class="fw-bold">Lengkapi Profil</h1>
                </div>
            </div>
            <div class="col-sm-5">
                ...
                <div class="card border-0 shadow-lg p-4" style="border-radius: 16px;">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="email" class="form-control" id="input-email" onclick="return false" value="<?= $email ?>" disabled="true" required>
                            <div class="invalid-feedback">
                                Email Masih Kosong
                            </div>
                        </div>
                ...
                <div class="card border-0 shadow-lg p-4" style="border-radius: 16px;">
                    <div class="card-body">
                        ...
                        <div class="my-4">
                            ...
                            <input type="hidden" value="<?= $id_loker ?>" id="id-loker">
                            <input type="hidden" value="<?= $id_account ?>" id="id-account">
                            <div class="invalid-feedback">
