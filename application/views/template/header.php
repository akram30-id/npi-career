...
<body>
        ...
        <div class="container-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <div class="dropdown" id="account">
                    <!-- NOTIFICATION -->
                    <button class="btn btn-white" style="color: #062173;" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><i class="bi bi-bell-fill"></i><sup class="fw-bold text-danger" id="total-notif"></sup></button>

                    <!-- ACCOUNT -->
                    <button class="btn btn-white dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi bi-person-circle" style="color: #062173;"></i>
                    </button>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" id="account">My Profile</a></li>
    ...
    <!-- NOTIF OFFCANVAS -->
    <div class="offcanvas offcanvas-end" style="background-color: rgba(0, 0, 0, 0.3)" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 class="offcanvas-title text-white fw-bold" id="offcanvasRightLabel">Notifications</h5>
